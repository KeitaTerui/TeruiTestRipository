<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="cart002.aspx.vb" EnableViewState="true" ValidateRequest="false"
    EnableEventValidation="false" Inherits="tw.page_cart_cart002" %>
...
<head runat="server">
    ...
    <script id="fromKanaToRomenConvertUtil" type="text/javascript" src="/scripts/custom/fromKanaToRomenConvertUtil.js" charset="UTF-8"></script>
    <style type="text/css">
    ...
    <script type="text/javascript">
        ...
        function createTag1() {
            ...
            if (document.getElementById("triphoowebHeader_SERVICE_VENDOR_IS_NSSOL").value == 'True') {
                script.src = document.getElementById("triphoowebHeader_WEB_TRIPHOO_RM_WEB_SERVICE_SERVICE_GET_LIST_URL").value + '?CALLBACK=ZIPCODE1&ZIPCODE=' + nzip;
            } else {
        ...
        function PassengerCopy() {
            if ($('#MAIN_PERSON_INPUTPanel')[0]) {

                try {
                    document.getElementById("PASSENGER_OTHERRepeater_SURNAME_ROMAN_0").value = document.getElementById("INPUT_MAIN_SURNAME_ROMAN").value;
                    document.getElementById("PASSENGER_OTHERRepeater_NAME_ROMAN_0").value = document.getElementById("INPUT_MAIN_NAME_ROMAN").value;
                } catch (ex) {

                }
                try {
                    document.getElementById("PASSENGER_OTHERRepeater_FAMILY_NAME_KANJI_0").value = document.getElementById("INPUT_MAIN_SURNAME_KANJI").value;
                    document.getElementById("PASSENGER_OTHERRepeater_FIRST_NAME_KANJI_0").value = document.getElementById("INPUT_MAIN_NAME_KANJI").value;
                } catch (ex) {

                }
                try {
                    document.getElementById("PASSENGER_OTHERRepeater_FAMILY_NAME_KANA_0").value = document.getElementById("INPUT_MAIN_SURNAME_KANA").value;
                    document.getElementById("PASSENGER_OTHERRepeater_FIRST_NAME_KANA_0").value = document.getElementById("INPUT_MAIN_NAME_KANA").value;
                } catch (ex) {

                }
                try {
                    document.getElementById("PASSENGER_OTHERRepeater_MAN_0").checked = document.getElementById("INPUT_MAIN_MAN").checked;
                    document.getElementById("PASSENGER_OTHERRepeater_WOMAN_0").checked = document.getElementById("INPUT_MAIN_WOMAN").checked;
                } catch (ex) {

                }
                try {
                    document.getElementById("PASSENGER_OTHERRepeater_BIRTH_YYYY_0").value = document.getElementById("INPUT_MAIN_BIRTH_YYYY").value;
                    document.getElementById("PASSENGER_OTHERRepeater_BIRTH_MM_0").value = document.getElementById("INPUT_MAIN_BIRTH_MM").value;
                    document.getElementById("PASSENGER_OTHERRepeater_BIRTH_DD_0").value = document.getElementById("INPUT_MAIN_BIRTH_DD").value;
                } catch (ex) {
                ...
                try {
                    document.getElementById("PASSENGER_OTHERRepeater_SURNAME_ROMAN_0").value = document.getElementById("MAIN_SURNAME_ROMAN").innerText;
                    document.getElementById("PASSENGER_OTHERRepeater_NAME_ROMAN_0").value = document.getElementById("MAIN_NAME_ROMAN").innerText;
                } catch (ex) {

                }
                try {
                    document.getElementById("PASSENGER_OTHERRepeater_FAMILY_NAME_KANJI_0").value = document.getElementById("MAIN_SURNAME_KANJI").innerText;
                    document.getElementById("PASSENGER_OTHERRepeater_FIRST_NAME_KANJI_0").value = document.getElementById("MAIN_NAME_KANJI").innerText;
                } catch (ex) {

                }
                try {
                    document.getElementById("PASSENGER_OTHERRepeater_FAMILY_NAME_KANA_0").value = document.getElementById("MAIN_SURNAME_KANA").innerText;
                    document.getElementById("PASSENGER_OTHERRepeater_FIRST_NAME_KANA_0").value = document.getElementById("MAIN_NAME_KANA").innerText;
                } catch (ex) {

                }
                try {
                    switch (document.getElementById("MAIN_SEX_KBN").innerText) {
                        case "01": document.getElementById("PASSENGER_OTHERRepeater_MAN_0").checked = true; break;
                        case "02": document.getElementById("PASSENGER_OTHERRepeater_WOMAN_0").checked = true; break;
                    }
                } catch (ex) {

                }
                try {
                    document.getElementById("PASSENGER_OTHERRepeater_BIRTH_YYYY_0").value = document.getElementById("MAIN_BIRTH_YYYY").innerText;
                    document.getElementById("PASSENGER_OTHERRepeater_BIRTH_MM_0").value = document.getElementById("MAIN_BIRTH_MM").innerText;
                    document.getElementById("PASSENGER_OTHERRepeater_BIRTH_DD_0").value = document.getElementById("MAIN_BIRTH_DD").innerText;
                } catch (ex) {
        ...
        function PassengerHotelCopy() {
            if ($('#MAIN_PERSON_INPUTPanel')[0]) {

                try {
                    document.getElementById("PASSENGER_HOTELRepeater_PASSENGER_HOTEL_NAMERepeater_0_SURNAME_ROMAN_0").value = document.getElementById("INPUT_MAIN_SURNAME_ROMAN").value;
                    document.getElementById("PASSENGER_HOTELRepeater_PASSENGER_HOTEL_NAMERepeater_0_NAME_ROMAN_0").value = document.getElementById("INPUT_MAIN_NAME_ROMAN").value;
                } catch (ex) {

                }
                try {
                    document.getElementById("PASSENGER_HOTELRepeater_PASSENGER_HOTEL_NAMERepeater_0_FAMILY_NAME_KANJI_0").value = document.getElementById("INPUT_MAIN_SURNAME_KANJI").value;
                    document.getElementById("PASSENGER_HOTELRepeater_PASSENGER_HOTEL_NAMERepeater_0_FIRST_NAME_KANJI_0").value = document.getElementById("INPUT_MAIN_NAME_KANJI").value;
                } catch (ex) {

                }
                try {
                    document.getElementById("PASSENGER_HOTELRepeater_PASSENGER_HOTEL_NAMERepeater_0_FAMILY_NAME_KANA_0").value = document.getElementById("INPUT_MAIN_SURNAME_KANA").value;
                    document.getElementById("PASSENGER_HOTELRepeater_PASSENGER_HOTEL_NAMERepeater_0_FIRST_NAME_KANA_0").value = document.getElementById("INPUT_MAIN_NAME_KANA").value;
                } catch (ex) {

                }
                try {
                    document.getElementById("PASSENGER_HOTELRepeater_PASSENGER_HOTEL_NAMERepeater_0_MAN_0").checked = document.getElementById("INPUT_MAIN_MAN").checked;
                    document.getElementById("PASSENGER_HOTELRepeater_PASSENGER_HOTEL_NAMERepeater_0_WOMAN_0").checked = document.getElementById("INPUT_MAIN_WOMAN").checked;
                } catch (ex) {

                }
                try {
                    document.getElementById("PASSENGER_HOTELRepeater_PASSENGER_HOTEL_NAMERepeater_0_BIRTH_YYYY_0").value = document.getElementById("INPUT_MAIN_BIRTH_YYYY").value;
                    document.getElementById("PASSENGER_HOTELRepeater_PASSENGER_HOTEL_NAMERepeater_0_BIRTH_MM_0").value = document.getElementById("INPUT_MAIN_BIRTH_MM").value;
                    document.getElementById("PASSENGER_HOTELRepeater_PASSENGER_HOTEL_NAMERepeater_0_BIRTH_DD_0").value = document.getElementById("INPUT_MAIN_BIRTH_DD").value;
                } catch (ex) {
                ...
                try {
                    document.getElementById("PASSENGER_HOTELRepeater_PASSENGER_HOTEL_NAMERepeater_0_SURNAME_ROMAN_0").value = document.getElementById("MAIN_SURNAME_ROMAN").innerText;
                    document.getElementById("PASSENGER_HOTELRepeater_PASSENGER_HOTEL_NAMERepeater_0_NAME_ROMAN_0").value = document.getElementById("MAIN_NAME_ROMAN").innerText;
                } catch (ex) {

                }
                try {
                    document.getElementById("PASSENGER_HOTELRepeater_PASSENGER_HOTEL_NAMERepeater_0_FAMILY_NAME_KANJI_0").value = document.getElementById("MAIN_SURNAME_KANJI").innerText;
                    document.getElementById("PASSENGER_HOTELRepeater_PASSENGER_HOTEL_NAMERepeater_0_FIRST_NAME_KANJI_0").value = document.getElementById("MAIN_NAME_KANJI").innerText;
                } catch (ex) {

                }
                try {
                    document.getElementById("PASSENGER_HOTELRepeater_PASSENGER_HOTEL_NAMERepeater_0_FAMILY_NAME_KANA_0").value = document.getElementById("MAIN_SURNAME_KANA").innerText;
                    document.getElementById("PASSENGER_HOTELRepeater_PASSENGER_HOTEL_NAMERepeater_0_FIRST_NAME_KANA_0").value = document.getElementById("MAIN_NAME_KANA").innerText;
                } catch (ex) {

                }
                try {
                    switch (document.getElementById("MAIN_SEX_KBN").innerText) {
                        case "01": document.getElementById("PASSENGER_HOTELRepeater_PASSENGER_HOTEL_NAMERepeater_0_MAN_0").checked = true; break;
                        case "02": document.getElementById("PASSENGER_HOTELRepeater_PASSENGER_HOTEL_NAMERepeater_0_WOMAN_0").checked = true; break;
                    }
                } catch (ex) {

                }
                try {
                    document.getElementById("PASSENGER_HOTELRepeater_PASSENGER_HOTEL_NAMERepeater_0_BIRTH_YYYY_0").value = document.getElementById("MAIN_BIRTH_YYYY").innerText;
                    document.getElementById("PASSENGER_HOTELRepeater_PASSENGER_HOTEL_NAMERepeater_0_BIRTH_MM_0").value = document.getElementById("MAIN_BIRTH_MM").innerText;
                    document.getElementById("PASSENGER_HOTELRepeater_PASSENGER_HOTEL_NAMERepeater_0_BIRTH_DD_0").value = document.getElementById("MAIN_BIRTH_DD").innerText;
                } catch (ex) {
        ...
        <div class="container">
            <div class="row">
                ...
                <div id="triphoomain" class="col-lg-9">
                    ...
                    <asp:Panel ID="PARTNERSPanel" runat="server" Visible="false">
                        ...
                        <div class="card mb-3 shadow">
                            <div class="card-header">
                                ...
                                <span class="badge badge-danger tw-badge-form mr-2">必須</span>E-mailアドレス
                            ...
                            <div class="card-header">
                                ...
                                <span class="badge badge-danger tw-badge-form mr-2">必須</span>ご担当者様名
                    ...
                    <p>
                        <asp:Label ID="LABEL_0008" runat="server"></asp:Label>
                    </p>
                    ...
                    <div class="card mb-3 shadow">
                        <asp:Panel ID="MAIN_PERSON_INPUTPanel" CssClass="listLine" runat="server">
                            ...
                            <div class="card-header">
                                <span class="badge badge-danger tw-badge-form mr-2">
                            ...
                            <asp:Panel ID="INPUT_MAIN_E_MAIL_CONFPanel" runat="server">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-danger mt-3" role="alert">
                                        ...
                                        <b>
                                            <asp:Label ID="LABEL_0185" runat="server"></asp:Label>
                                        </b>
                            ...
                            <asp:Panel ID="INPUT_MAIN_NAME_KANAPanel" runat="server" Visible="false">
                                <div class="card-header">
                                    ...
                                    <span class="badge badge-danger tw-badge-form mr-2">必須</span>
                                    姓名:カナ (全角カナ)
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="input-group" style="margin-bottom: 0px;">
                                                ...
                                                <asp:TextBox ID="INPUT_MAIN_SURNAME_KANA" runat="server" class="form-control form-control-lg convertKana" MaxLength="100" placeholder="例：ヤマダ" onblur="$('.mainSurNameKana').val(convertKanaToRome(this.value));"></asp:TextBox>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="input-group" style="margin-bottom: 0px;">
                                                ...
                                                <asp:TextBox ID="INPUT_MAIN_NAME_KANA" runat="server" class="form-control form-control-lg convertKana" MaxLength="100" placeholder="例：タロウ" onblur="$('.mainNameKana').val(convertKanaToRome(this.value));"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <asp:Panel ID="COUPON_CD_AFFILIATEPanel" runat="server" Visible="false">
                                ...
                                <div class="card-body">
                                    <asp:TextBox ID="COUPON_CD_AFFILIATE" runat="server" class="form-control form-control-lg" Style="text-transform: uppercase; ime-mode: disabled;" MaxLength="100"></asp:TextBox>
                                </div>
                        ...
                        <asp:Panel ID="MAIN_PERSON_LABELPanel" CssClass="listLine" runat="server">
                            ...
                            <asp:Panel ID="LABEL_MAIN_SEXPanel" runat="server">
                                ...
                                <div class="card-body">
                                    <asp:Label ID="MAIN_SEX_KBN" runat="server" CssClass="d-none"></asp:Label>
                            ...
                            <asp:Panel ID="LABEL_MAIN_BIRTHPanel" runat="server">
                                ...
                                <div class="card-body">
                                    <asp:Label ID="MAIN_BIRTH_YYYY" runat="server" CssClass="d-none"></asp:Label>
                                    <asp:Label ID="MAIN_BIRTH_MM" runat="server" CssClass="d-none"></asp:Label>
                                    <asp:Label ID="MAIN_BIRTH_DD" runat="server" CssClass="d-none"></asp:Label>
                                    ...
                                    <asp:Repeater ID="MAIN_PERSON_TOUR_SERVICERepeater" runat="server" Visible="false">
                                        <ItemTemplate>
                                            <div class="card-header">
                                                ...
                                                <%# IIf(Eval("SELECT_KBN") = "1", "<span class='badge badge-danger tw-badge-form mr-2' style='margin-left: 5px; margin-right: 5px;'>必須</span>", "<span class='badge badge-success tw-badge-form mr-2' style='margin-left: 5px; margin-right: 5px;'>任意</span>") %>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <asp:Panel ID="RES_SERVICE_TOUR_CHECKBOXPanel" runat="server" Visible="false">
                                                    <div class="row">
                                                        <div class="col-lg-6 pd10">
                                                            <asp:CheckBox ID="SERVICE_PRICE_CD_CHECKBOX" runat="server" />
                                                        </div>
                                                ...
                                                <%--付帯の備考--%>
                                                <%# IIf(Not Eval("SERVICE_DISP_REMARKS").Equals(""), "<p class='small mt-2 mb-0'>" & Eval("SERVICE_DISP_REMARKS").ToString & "</p>", "") %>
                                            </div>
                        ...
                        <%--▼代表者情報（ターキッシュ用）--%>
                        <%--▼ターキッシュ　代表者INPUT--%>
                        <asp:Panel ID="MAIN_PERSON_INPUT_A0074Panel" CssClass="listLine" runat="server" Visible="false">
                            <asp:Panel ID="INPUT_MAIN_SURNAME_KANJI_A0074Panel" runat="server">
                                <div class="card-header">
                                    <span class="badge badge-danger tw-badge-form mr-2">
                                        <asp:Label ID="LABEL_0214" runat="server"></asp:Label></span>
                                    <asp:Label ID="LABEL_0215" runat="server"></asp:Label>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="input-group" style="margin-bottom: 0px;">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" style="width: 100px;">
                                                        <asp:Label ID="LABEL_0216" runat="server"></asp:Label>
                                                    </span>
                                                </div>
                                                <asp:TextBox ID="INPUT_MAIN_SURNAME_KANJI_A0074" runat="server" class="form-control form-control-lg" MaxLength="100"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="input-group" style="margin-bottom: 0px;">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" style="width: 100px;">
                                                        <asp:Label ID="LABEL_0217" runat="server"></asp:Label>
                                                    </span>
                                                </div>
                                                <asp:TextBox ID="INPUT_MAIN_NAME_KANJI_A0074" runat="server" class="form-control form-control-lg" MaxLength="100"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </asp:Panel>
                            <asp:Panel ID="INPUT_MAIN_NAME_ROMAN_A0074Panel" runat="server">
                                <div class="card-header">
                                    <span class="badge badge-danger tw-badge-form mr-2">
                                        <asp:Label ID="LABEL_0218" runat="server"></asp:Label></span>
                                    <asp:Label ID="LABEL_0219" runat="server"></asp:Label>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="input-group" style="margin-bottom: 0px;">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" style="width: 100px;">
                                                        <asp:Label ID="LABEL_0220" runat="server"></asp:Label>
                                                    </span>
                                                </div>
                                                <asp:TextBox ID="INPUT_MAIN_SURNAME_ROMAN_A0074" runat="server" class="form-control form-control-lg mainSurNameKana"
                                                    Style="text-transform: uppercase; ime-mode: disabled" MaxLength="100"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="input-group" style="margin-bottom: 0px;">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" style="width: 100px;">
                                                        <asp:Label ID="LABEL_0221" runat="server"></asp:Label>
                                                    </span>
                                                </div>
                                                <asp:TextBox ID="INPUT_MAIN_NAME_ROMAN_A0074" runat="server" class="form-control form-control-lg mainNameKana"
                                                    Style="text-transform: uppercase; ime-mode: disabled" MaxLength="100"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <p class="small mb-0" style="padding:0.375rem 0 0 0.75rem; color:#495057";>
                                                <asp:Label ID="LABEL_0257" runat="server"></asp:Label>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            </asp:Panel>
                            <asp:Panel ID="INPUT_MAIN_SEX_A0074Panel" runat="server">
                                <div class="card-header">
                                    <span class="badge badge-danger tw-badge-form mr-2">
                                        <asp:Label ID="LABEL_0222" runat="server"></asp:Label></span>
                                    <asp:Label ID="LABEL_0223" runat="server"></asp:Label>
                                </div>
                                <div class="card-body">
                                    <asp:RadioButton GroupName="INPUT_MAIN_SEX_FLG_A0074" ID="INPUT_MAIN_MAN_A0074" runat="server" />
                                    <asp:RadioButton GroupName="INPUT_MAIN_SEX_FLG_A0074" ID="INPUT_MAIN_WOMAN_A0074" runat="server" />
                                    <asp:Label ID="INPUT_MAIN_SEX_FLG_LABEL_A0074" runat="server" Visible="false" CssClass="pd10"></asp:Label>
                                </div>
                            </asp:Panel>
                            <asp:Panel ID="INPUT_MAIN_AGE_A0074Panel" runat="server">
                                <div class="card-header">
                                    <span class="badge badge-danger tw-badge-form mr-2">
                                        <asp:Label ID="LABEL_0224" runat="server"></asp:Label></span>
                                    <asp:Label ID="LABEL_0225" runat="server"></asp:Label>
                                </div>
                                <div class="card-body">
                                    <%--★★★ここに年齢のプルダウン--%>
                                    <asp:DropDownList ID="INPUT_MAIN_AGE_A0074" Style="width: 200px; ime-mode: disabled" runat="server" class="form-control form-control-lg">
                                    </asp:DropDownList>
                                </div>
                            </asp:Panel>
                            <asp:Panel ID="INPUT_MAIN_ADDRESS_A0074Panel" runat="server">
                                <div class="card-header">
                                    <span class="badge badge-danger tw-badge-form mr-2">
                                        <asp:Label ID="LABEL_0226" runat="server"></asp:Label></span>
                                    <asp:Label ID="LABEL_0227" runat="server"></asp:Label>
                                </div>
                                <div class="card-body">
                                    <asp:DropDownList ID="INPUT_MAIN_PREFECTURE_A0074" Style="width: 200px; ime-mode: disabled" runat="server" class="form-control form-control-lg">
                                    </asp:DropDownList>
                                </div>
                            </asp:Panel>
                            <asp:Panel ID="INPUT_MAIN_E_MAIL_A0074Panel" runat="server">
                                <div class="card-header">
                                    <span class="badge badge-danger tw-badge-form mr-2">
                                        <asp:Label ID="LABEL_0228" runat="server"></asp:Label></span>
                                    <asp:Label ID="LABEL_0229" runat="server"></asp:Label>
                                </div>
                                <div class="card-body">
                                    <asp:Label ID="INPUT_MAIN_E_MAIL_A0074Label" runat="server" Visible="false"></asp:Label>
                                    <asp:TextBox ID="INPUT_MAIN_E_MAIL_A0074" runat="server" class="form-control form-control-lg" MaxLength="200"></asp:TextBox>
                                </div>
                            </asp:Panel>
                            <asp:Panel ID="INPUT_MAIN_E_MAIL_CONF_A0074Panel" runat="server">
                                <div class="card-header">
                                    <span class="badge badge-danger tw-badge-form mr-2">
                                        <asp:Label ID="LABEL_0232" runat="server"></asp:Label></span>
                                    <asp:Label ID="LABEL_0233" runat="server"></asp:Label>
                                </div>
                                <div class="card-body">
                                    <asp:TextBox ID="INPUT_MAIN_E_MAIL_CONF_A0074" runat="server" class="form-control form-control-lg" MaxLength="200" oncopy="return false" onpaste="return false" oncontextmenu="return false"></asp:TextBox>
                                </div>
                            </asp:Panel>
                            <asp:Panel ID="INPUT_MAIN_TEL_NO_A0074Panel" runat="server">
                                <div class="card-header">
                                    <span class="badge badge-danger tw-badge-form mr-2">
                                        <asp:Label ID="LABEL_0230" runat="server"></asp:Label></span>
                                    <asp:Label ID="LABEL_0231" runat="server"></asp:Label>
                                </div>
                                <div class="card-body">
                                    <asp:TextBox ID="INPUT_MAIN_TEL_NO_A0074" runat="server" class="form-control form-control-lg" MaxLength="200"></asp:TextBox>
                                </div>
                            </asp:Panel>
                        </asp:Panel> 
                        <%--▲ターキッシュ　代表者INPUT--%>
                        <%--▼ターキッシュ　代表者LABEL--%>
                        <asp:Panel ID="MAIN_PERSON_LABEL_A0074Panel" CssClass="listLine" runat="server" Visible="false">
                            <asp:Panel ID="LABEL_MAIN_SURNAME_KANJI_A0074Panel" runat="server">
                                <div class="card-header">
                                    <asp:Label ID="LABEL_0248" runat="server"></asp:Label>
                                </div>
                                <div class="card-body">
                                    <asp:Label ID="MAIN_SURNAME_KANJI_A0074" runat="server"></asp:Label>&nbsp;
                                    <asp:Label ID="MAIN_NAME_KANJI_A0074" runat="server"></asp:Label>
                                </div>
                            </asp:Panel>
                            <asp:Panel ID="LABEL_MAIN_SURNAME_ROMAN_A0074Panel" runat="server">
                                <div class="card-header">
                                    <asp:Label ID="LABEL_0249" runat="server"></asp:Label>
                                </div>
                                <div class="card-body">
                                    <asp:Label ID="MAIN_SURNAME_ROMAN_A0074" runat="server"></asp:Label>&nbsp;
                                    <asp:Label ID="MAIN_NAME_ROMAN_A0074" runat="server"></asp:Label>
                                </div>
                            </asp:Panel>
                            <asp:Panel ID="LABEL_MAIN_SEX_A0074Panel" runat="server">
                                <div class="card-header">
                                    <asp:Label ID="LABEL_0250" runat="server"></asp:Label>
                                </div>
                                <div class="card-body">
                                    <asp:Label ID="MAIN_SEX_KBN_A0074" runat="server" CssClass="d-none"></asp:Label>
                                    <asp:Label ID="MAIN_SEX_FLG_A0074" runat="server"></asp:Label>
                                </div>

                            </asp:Panel>
                            <asp:Panel ID="LABEL_MAIN_AGE_A0074Panel" runat="server">
                                <div class="card-header">
                                    <asp:Label ID="LABEL_0251" runat="server"></asp:Label>
                                </div>
                                <div class="card-body">
                                    <asp:Label ID="MAIN_AGE_A0074" runat="server"></asp:Label>
                                </div>
                            </asp:Panel>
                            <asp:Panel ID="LABEL_MAIN_ADDRESS_A0074Panel" runat="server">
                                <div class="card-header">
                                    <asp:Label ID="LABEL_0252" runat="server"></asp:Label>
                                </div>
                                <div class="card-body">
                                    <asp:Label ID="MAIN_PREFECTURE_A0074" runat="server"></asp:Label>
                                </div>
                            </asp:Panel>
                            <asp:Panel ID="LABEL_MAIN_E_MAIL_A0074Panel" runat="server">
                                <div class="card-header">
                                    <asp:Label ID="LABEL_0253" runat="server"></asp:Label>
                                </div>
                                <div class="card-body">
                                    <asp:Label ID="MAIN_E_MAIL_A0074" runat="server"></asp:Label>
                                </div>
                            </asp:Panel>
                            <asp:Panel ID="MAIN_TEL_NO_A0074Panel" runat="server">
                                <div class="card-header">
                                    <asp:Label ID="LABEL_0254" runat="server"></asp:Label>
                                </div>
                                <div class="card-body">
                                    <asp:Label ID="MAIN_TEL_NO_A0074" runat="server"></asp:Label>
                                </div>
                            </asp:Panel>
                        </asp:Panel>
                        <%--▲ターキッシュ　代表者LABEL--%>
                    ...
                    <%--航空会社Eメール登録--%>
                    <asp:Panel ID="EMAIL_OPTION" runat="server">
                        <div class="col-lg-12 mt-5 mb-3">
                            <asp:CheckBox class="text-center" ID="MAIL_SEND_TO_CARRIER_FLG_CHECKBOX" runat="server" />
                            <asp:Label ID="LABEL_0213" runat="server"></asp:Label>
                        </div>
                    </asp:Panel>
                    ...
                    <asp:Panel ID="PASSENGERPanel" CssClass="pdt20" runat="server">
                        ...
                        <asp:Panel ID="PASSENGER_OTHERPanel" runat="server" Visible="false">
                            <div class="card mb-3 shadow">
                                <asp:Repeater ID="PASSENGER_OTHERRepeater" runat="server">
                                    <ItemTemplate>
                                        <div class="card-header">
                                            <span class="badge badge-danger tw-badge-form mr-2"><%= LABEL_0053 %></span>
                                            ...
                                            <asp:LinkButton ID="MainPersonCopyLinkButton" runat="server" OnClientClick="return PassengerCopy()" CssClass="btn btn-danger fltR MainPersonCopy"><%=LABEL_0210 %></asp:LinkButton>
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <asp:Panel ID="NAME_KANAPanel" runat="server" CssClass="row">
                                                <div class="col-lg-6">
                                                    <div class="input-group">
                                                        ...
                                                        <asp:TextBox ID="FAMILY_NAME_KANA" runat="server" class="form-control form-control-lg convertKana" onblur="RepeaterItemConvert(this);"
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="input-group">
                                                        ...
                                                        <asp:TextBox ID="FIRST_NAME_KANA" runat="server" class="form-control form-control-lg convertKana" onblur="RepeaterItemConvert(this);"
                                            ...
                                            <asp:Panel ID="NATIONALITYPanel" runat="server" CssClass="row">
                                                                    ...
                                                                    <asp:Repeater ID="RES_SERVICE_SUBRepeater" runat="server">
                                                                        <ItemTemplate>
                                                                            <div class="col-lg-12 pdt5">
                                                                                <div class="input-group">
                                                                                    <div class="input-group-prepend">
                                                                                        <%--1:受託手荷物、2:食事、3:座席、4:コンフォートキット、5:ビデオオンデマンド、6:機内持込手荷物、7:スポーツ用品、9:その他--%>
                                            ...
                                            <asp:Repeater ID="RES_SERVICE_TOURRepeater" runat="server" Visible="false">
                                                <ItemTemplate>
                                                    <div class="card-header">
                                                        ...
                                                        <%# IIf(Eval("SELECT_KBN") = "1", "<span class='badge badge-danger tw-badge-form mr-2' style='margin-left: 5px; margin-right: 5px;'>" + LABEL_0104_COM + "</span>", "<span class='badge badge-success tw-badge-form mr-2' style='margin-left: 5px; margin-right: 5px;'>" + LABEL_0106_COM + "</span>") %>
                                                        <asp:Label ID="SERVICE_NM" runat="server" Text='<%# Eval("SERVICE_NM")%>'></asp:Label>
                                                        <%# IIf(Eval("SELECT_WAY_KBN") = "2", "<br/>(複数選択可)", "")%>
                                                    </div>
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-lg-6 pd10">
                                                                ...
                                                                <asp:Panel ID="RES_SERVICE_TOUR_PAX_OTHER_DROPDOWNPanel" runat="server" Visible="false">
                                                                    <div class="row">
                                                                        <div class="col-lg-6">
                                                                            <asp:DropDownList ID="RES_SERVICE_TOUR_PAX_OTHER_DROPDOWNLIST" runat="server" class="form-control form-control-lg">
                                                                            </asp:DropDownList>
                                                                        </div>
                                                                        <div class="col-lg-6">
                                                                            <div class="input-group">
                                                                                <div class="input-group-prepend">
                                                                                    <span class="input-group-text" style="width: 100px;"><%=LABEL_0235%></span>
                                                                                </div>
                                                                                <asp:DropDownList ID="RES_SERVICE_TOUR_PAX_OTHER_DROPDOWNLIST_QUANTITY" class="form-control form-control-lg" runat="server">
                                                                                </asp:DropDownList>
                                                                                <div class="input-group-prepend">
                                                                                    <span class="input-group-text" style="width: 100px;"><%=LABEL_0255%></span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </asp:Panel>
                                                                <asp:Repeater ID="RES_SERVICE_TOUR_PAX_OTHER_RADIORepeater" runat="server" Visible="false">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="PAX_OTHER_SERVICE_PRICE_CD" runat="server" Text='<%# Eval("SERVICE_PRICE_CD")%>' Visible="false"></asp:Label>
                                                                        <asp:Label ID="PAX_OTHER_SERVICE_PRICE_NM" runat="server" Text='<%# Eval("SERVICE_PRICE_NM")%>' Visible="false"></asp:Label>
                                                                        <asp:RadioButton ID="RES_SERVICE_TOUR_PAX_OTHER_RADIO" GroupName="SERVICE_PRICE_CD_RADIO_FLG" runat="server" onclick="ServiceRadioButton(this)"/>
                                                                        <asp:Label ID="RES_SERVICE_TOUR_PAX_OTHER_RADIO_NM_DISP" runat="server"></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:Repeater>
                                                                <%--付帯の備考--%>
                                                                <%# IIf(Not Eval("SERVICE_DISP_REMARKS").Equals(""), "<p class='small mt-2 mb-0'>" & Eval("SERVICE_DISP_REMARKS").ToString & "</p>", "") %>
                                        ...
                                        <asp:Panel ID="RES_OPTION_SELECT_ITEMPanel" runat="server" Visible="false">
                                            <asp:Repeater ID="RES_OPTION_SELECT_ITEMRepeater" runat="server">
                                                <ItemTemplate>
                                                    <asp:Label ID="OPTION_SEQ" runat="server" Text='<%# Eval("OPTION_SEQ")%>' Visible="false"></asp:Label>
                                                    <asp:Label ID="PAX_SEQ" runat="server" Text='<%# Eval("PAX_SEQ")%>' Visible="false"></asp:Label>
                                                    <asp:Label ID="ITEM_ID" runat="server" Text='<%# Eval("ITEM_ID")%>' Visible="false"></asp:Label>
                                                    <asp:Label ID="INPUT_TYPE" runat="server" Text='<%# Eval("INPUT_TYPE")%>' Visible="false"></asp:Label>
                                                    <asp:Label ID="REQUIRED_FLG" runat="server" Text='<%# Eval("REQUIRED_FLG")%>' Visible="false"></asp:Label>
                                                    <div class="card-header">
                                                        <%# IIf(Eval("REQUIRED_FLG"), "<span class='badge badge-danger tw-badge-form mr-2' style='margin-left: 5px; margin-right: 5px;'>必須</span>", "") %>
                                                        <asp:Label ID="NM" runat="server" Text='<%# Eval("NM")%>'></asp:Label>
                                                        <%# IIf(Not Eval("REQUIRED_FLG"), "(" + LABEL_0106_COM + ")", "") %>
                                                    </div>
                                                    <div class="card-body">
                                                        <asp:Panel ID="ITEMTextBoxPanel" runat="server" Visible='<%# IIf(Eval("INPUT_TYPE") = "01", True, False)%>'>
                                                            <asp:TextBox ID="ITEM_TextBox" runat="server" CssClass="form-control" placeholder='<%# Eval("DESCRIPTION") %>'></asp:TextBox>
                                                        </asp:Panel>
                                                        <asp:Panel ID="ITEMDropDownListPanel" runat="server" Visible='<%# IIf(Eval("INPUT_TYPE") = "02", True, False)%>'>
                                                            <asp:DropDownList ID="ITEM_DropDownList" runat="server" CssClass="form-control"></asp:DropDownList>
                                                        </asp:Panel>
                                                        <asp:Panel ID="ITEM_RadioButtonPanel" runat="server" Visible='<%# IIf(Eval("INPUT_TYPE") = "03", True, False)%>'>
                                                            <asp:RadioButton ID="ITEM_YES_RadioButton" runat="server" Text="はい" GroupName='<%# Eval("ITEM_ID")%>' />
                                                            <asp:RadioButton ID="ITEM_NO_RadioButton" runat="server" Text="いいえ" GroupName='<%# Eval("ITEM_ID")%>' />
                                                        </asp:Panel>
                                                    </div>
                                                </ItemTemplate>
                                            </asp:Repeater>
                                        ...
                                        <asp:Repeater ID="PASSENGER_HOTEL_NAMERepeater" runat="server">
                                            <ItemTemplate>
                                                <div class="card-header">
                                                    ...
                                                    <asp:LinkButton ID="MainPersonCopyLinkButton" runat="server" OnClientClick="return PassengerHotelCopy()" CssClass="btn btn-danger fltR MainPersonCopy">代表者をコピー</asp:LinkButton>
                                                </div>
                                                <div class="card-body">
                                                    <asp:Panel ID="NAME_KANJIPanel" runat="server" CssClass="row">
                                                        <div class="col-lg-6">
                                                    ...
                                                    <asp:Panel ID="RES_SERVICEPanel" runat="server" Visible="false" CssClass="mt-2">
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                    ...
                                                    <asp:Panel ID="RES_SERVICE_TOURPanel" runat="server" Visible="false" CssClass="mt-2">
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <asp:Repeater ID="RES_SERVICE_TOURRepeater" runat="server" Visible="false">
                                                                    <ItemTemplate>
                                                                        <div class="alert alert-secondary  ng-binding" role="alert">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-lg-12 pd10">
                                                                                    ...
                                                                                    <asp:Panel ID="RES_SERVICE_TOUR_PAX_HOTEL_DROPDOWNPanel" runat="server" Visible="false">
                                                                                        <div class="row">
                                                                                            <div class="col-lg-6">
                                                                                                <asp:DropDownList ID="RES_SERVICE_TOUR_PAX_HOTEL_DROPDOWNLIST" runat="server" class="form-control form-control-lg">
                                                                                                </asp:DropDownList>
                                                                                            </div>
                                                                                            <div class="col-lg-6">
                                                                                                <div class="input-group">
                                                                                                    ...
                                                                                                    <asp:DropDownList ID="RES_SERVICE_TOUR_PAX_HOTEL_DROPDOWNLIST_QUANTITY" class="form-control form-control-lg" runat="server">
                                                                                                    </asp:DropDownList>
                                                                                                    <div class="input-group-prepend">
                                                                                                        <span class="input-group-text" style="width: 100px;"><%=LABEL_0255%></span>
                                                                                                    </div>
                                                                                    ...
                                                                                    <asp:Repeater ID="RES_SERVICE_TOUR_PAX_HOTEL_RADIORepeater" runat="server" Visible="false">
                                                                                        <ItemTemplate>
                                                                                            <asp:Label ID="PAX_HOTEL_SERVICE_PRICE_CD" runat="server" Text='<%# Eval("SERVICE_PRICE_CD")%>' Visible="false"></asp:Label>
                                                                                            <asp:Label ID="PAX_HOTEL_SERVICE_PRICE_NM" runat="server" Text='<%# Eval("SERVICE_PRICE_NM")%>' Visible="false"></asp:Label>
                                                                                            <asp:RadioButton ID="RES_SERVICE_TOUR_PAX_HOTEL_RADIO" GroupName="SERVICE_PRICE_CD_RADIO_FLG" runat="server" onclick="ServiceRadioButton(this)"/>
                                                                                            <asp:Label ID="RES_SERVICE_TOUR_PAX_HOTEL_RADIO_NM_DISP" runat="server"></asp:Label>
                                                                                        </ItemTemplate>
                                                                                    </asp:Repeater>
                                                                                    <%--付帯の備考--%>
                                                                                    <%# IIf(Not Eval("SERVICE_DISP_REMARKS").Equals(""), "<p class='small mt-2 mb-0'>" & Eval("SERVICE_DISP_REMARKS").ToString & "</p>", "") %>
                        ...
                        <asp:Panel ID="PASSENGER_NOT_RES_SERVICEPanel" runat="server" Visible="false">
                            <div class="card mb-3 shadow">
                                <asp:Repeater ID="PASSENGER_NOT_RES_SERVICERepeater" runat="server">
                                    <ItemTemplate>
                                        <div class="card-header">
                                                <span class="badge badge-danger tw-badge-form mr-2"><%= LABEL_0053 %></span>
                                                <asp:Label ID="AGE_KBN" runat="server" Text='<%# Eval("AGE_KBN") %>' Visible="false"></asp:Label>
                                        ...
                                        <div class="card-body">
                                            <asp:Panel ID="NAME_KANJIPanel" runat="server" CssClass="row mt-2">
                                                <div class="col-lg-6">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" style="width: 100px;">姓
                                            ...
                                            <asp:Panel ID="NAME_ROMANPanel" runat="server" CssClass="row mt-2">
                                                <div class="col-lg-6">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" style="width: 100px;"><%=LABEL_0080%></span>
                                            ...
                                            <div class="row mt-2">
                                                <asp:Panel ID="SEXPanel" runat="server" CssClass="col-lg-6">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" style="width: 100px;"><%= LABEL_0084%></span>
                                                        </div>
                                                        <div class="form-control-lg fs16" style="padding-left: 0;">
                                                            <asp:RadioButton GroupName="SEX_FLG" ID="MAN" runat="server" Text="<%# LABEL_0085%>" />
                                                            <asp:RadioButton GroupName="SEX_FLG" ID="WOMAN" runat="server" Text='<%# LABEL_0086%>' />
                                                            <%--<asp:RadioButton GroupName="SEX_FLG" ID="NOANSWER" runat="server" Text='回答しない' Visible="false" />--%>
                                                        </div>
                                                ...
                                                <asp:Panel ID="AGEPanel" runat="server" CssClass="col-auto">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" style="width: 100px;"><asp:Label ID="AGELabel" runat="server"></asp:Label></span>
                                                        </div>
                                                        <%--★★★ここに年齢のプルダウン--%>
                                                        <asp:DropDownList ID="AGE" runat="server" class="form-control form-control-lg">
                                                        </asp:DropDownList>
                                                    </div>
                                                </asp:Panel>
                                            </div>
                    ...
                    <asp:Panel ID="RemarksPanel" runat="server">
                        ...
                        <div class="card mb-3 shadow">
                            <asp:Panel ID="T_RES_OPTION_SELECT_ITEMPanel" runat="server" Visible="false">
                                <asp:Repeater ID="T_RES_OPTION_SELECT_ITEMRepeater" runat="server">
                                    <ItemTemplate>
                                        <asp:Label ID="T_OPTION_SEQ" runat="server" Style='<%#IIF(Eval("OPTION_SEQ") = "","display:none","")%>' Visible="false" Text='<%# Eval("OPTION_SEQ")%>'></asp:Label>
                                        <asp:Label ID="T_SEQ" runat="server" Style='<%#IIF(Eval("SEQ") = "","display:none","")%>' Visible="false" Text='<%# Eval("SEQ")%>'></asp:Label>
                                        <div class="card-header">
                                            <div style="font-weight: bolder;">
                                                <asp:Label ID="T_NM" runat="server" Style='<%#IIF(Eval("NM") = "","display:none","")%>' Text='<%# Eval("NM")%>'></asp:Label>
                                            </div>
                                            <div style="font-size: small;">
                                                <asp:Label ID="T_REMARKS" runat="server" Style='<%#IIF(Eval("REMARKS") = "","display:none","")%>' Text='<%# Eval("REMARKS")%>'></asp:Label>
                                            </div>
                                        </div>
                                        <div class="card-body" style='<%#IIF(Eval("NM") <> "","display:none","")%>'>
                                            <asp:Panel ID="T_ITEMTextBoxPanel" runat="server">
                                                <asp:TextBox ID="T_ITEM_TextBox" runat="server" CssClass="form-control"></asp:TextBox>
                                            </asp:Panel>
                                        </div>
                                    </ItemTemplate>
                                </asp:Repeater>
                            ...
                            <asp:Panel ID="RES_SERVICE_TOURPanel" runat="server">
                                <asp:Repeater ID="RES_SERVICE_TOURRepeater" runat="server">
                                    <ItemTemplate>
                                        ...
                                        <asp:Label ID="SELECT_KBN" runat="server" Text='<%# Eval("SELECT_KBN")%>' Visible="false"></asp:Label>
                                        <div class="card-header">
                                            <%# IIf(Eval("SELECT_KBN") = "1", "<span class='badge badge-danger tw-badge-form mr-2' style='margin-left: 5px; margin-right: 5px;'>必須</span>", "<span class='badge badge-success tw-badge-form mr-2' style='margin-left: 5px; margin-right: 5px;'>" + LABEL_0106_COM + "</span>") %>
                                            <asp:Label ID="SERVICE_NM" runat="server" Text='<%# Eval("SERVICE_NM")%>'></asp:Label>
                                            <%# IIf(Eval("SELECT_WAY_KBN") = "2", "<br/>(複数選択可)", "")%>
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <asp:Panel ID="RES_SERVICE_TOUR_MAIN_DROPDOWNPanel" runat="server" Visible="false">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <asp:DropDownList ID="RES_SERVICE_TOUR_MAIN_DROPDOWNLIST" runat="server" class="form-control form-control-lg">
                                                        </asp:DropDownList>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="input-group">
                                                            ...
                                                            <asp:DropDownList ID="RES_SERVICE_TOUR_MAIN_DROPDOWNLIST_QUANTITY" class="form-control form-control-lg" runat="server">
                                                            </asp:DropDownList>
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text" style="width: 100px;"><%=LABEL_0236%></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </asp:Panel>
                                            <asp:Repeater ID="RES_SERVICE_TOUR_MAIN_RADIORepeater" runat="server" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="MAIN_SERVICE_PRICE_CD" runat="server" Text='<%# Eval("SERVICE_PRICE_CD")%>' Visible="false"></asp:Label>
                                                    <asp:Label ID="MAIN_SERVICE_PRICE_NM" runat="server" Text='<%# Eval("SERVICE_PRICE_NM")%>' Visible="false"></asp:Label>
                                                    <asp:RadioButton ID="RES_SERVICE_TOUR_MAIN_RADIO" GroupName="SERVICE_PRICE_CD_RADIO_FLG" runat="server" onclick="ServiceRadioButton(this)"/>
                                                    <asp:Label ID="RES_SERVICE_TOUR_MAIN_RADIO_NM_DISP" runat="server"></asp:Label>
                                                </ItemTemplate>
                                            </asp:Repeater>
                                            <%--付帯の備考--%>
                                            <%# IIf(Not Eval("SERVICE_DISP_REMARKS").Equals(""), "<p class='small mt-2 mb-0'>" & Eval("SERVICE_DISP_REMARKS").ToString & "</p>", "") %>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-5 col-12">
                                            <div class="input-group" style="margin-bottom: 0px;">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" style="width: 100px;"><%= LABEL_0206 %>
                                                    </span>
                                                </div>
                                        ...
                                        <div class="col-lg-5 col-12">
                                            <asp:Panel ID="LOCAL_ARR_TIMEPanel" runat="server" Visible="false">
                                                <div class="input-group" style="margin-bottom: 0px;">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text" style="width: 100px;"><%= LABEL_0207 %>
                                                        </span>
                                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-5 col-12">
                                            <div class="input-group" style="margin-bottom: 0px;">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" style="width: 100px;"><%= LABEL_0208 %>
                                                    </span>
                                                </div>
                                        ...
                                        <div class="col-lg-3 col-12" style="background-color: White;">
                                            <div class="input-group" style="margin-bottom: 0px;">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" style="width: 100px;"><%= LABEL_0209 %>
                                                    </span>
                                                </div>
                            ...
                            <asp:Panel ID="COUPON_CDPanel" runat="server" Visible="false">
                                ...
                                <div class="card-header">
                                    <asp:Label ID="LABEL_0211" runat="server"></asp:Label>
                                </div>
                                <div class="card-body">
                    ...
                    <asp:Panel ID="REGULATIONPanel" runat="server">
                        <asp:Panel ID="REGULATION_DEFAULTPanel" runat="server">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card-header">
                                        <asp:LinkButton ID="REGULATIONLinkButton" runat="server" OnClientClick="_RegModal();return false;">
                    ...
                    <div class="row">
                        <%--<div class="col-lg-6 col-12 p-3 d-none d-lg-block">
                        ...
                        <div class="col-lg-6 col-12 pt-0 pl-3 pr-3 pb-3 d-lg-none">
                            <asp:LinkButton ID="BackLinkButtonSP" runat="server" class="btn btn-block btn-lg-tw btn-primary"></asp:LinkButton>
                        </div>--%>
                        <asp:Panel ID="BackLinkButtonPanel" runat="server" CssClass="col-lg-6 col-12 p-3 d-none d-lg-block">
                            <asp:LinkButton ID="BackLinkButton" runat="server" class="btn btn-block btn-lg-tw btn-primary"></asp:LinkButton>
                        </asp:Panel>
<%--                        <asp:Panel ID="CONFIRMLinkButtonPanel" runat="server" CssClass="col-lg-6 col-12 p-3">--%>
                        <asp:Panel ID="CONFIRMLinkButtonPanel" runat="server">
                            <asp:LinkButton ID="CONFIRMLinkButton" runat="server" class="btn btn-block btn-lg-tw btn-danger"></asp:LinkButton>
                        </asp:Panel>
                        <asp:Panel ID="BackLinkButtonSPPanel" runat="server" CssClass="col-lg-6 col-12 pt-0 pl-3 pr-3 pb-3 d-lg-none">
                            <asp:LinkButton ID="BackLinkButtonSP" runat="server" class="btn btn-block btn-lg-tw btn-primary"></asp:LinkButton>
                        </asp:Panel>
                    </div>
        ...
        <script type="text/javascript">
            function ServiceRadioButton(element) {

                //選択したRadioButtonID
                element.id.checked = true;

                //選択したIDからRadioButtonグループを取得
                const get_id = element.id;
                const service_radio = get_id.replace(/_\d+$/, '');
                const Items_service_radio = document.querySelectorAll("[id^='" + service_radio + "']");

                //選択したID以外のIDを取得
                const Excluded_Items = Array.from(Items_service_radio).filter(item => !element.id.includes(item.id));

                //RadioButtonを外す
                Excluded_Items.forEach(item => {
                    item.checked = false;
                });
